# VectorQuantizer2 implementation from
...
class VectorQuantizer2(nn.Module):
    ...
    see https://github.com/CompVis/taming-transformers/blob/3ba01b241669f5ade541ce990f7650a3b8f65318/taming/modules/vqvae/quantize.py
